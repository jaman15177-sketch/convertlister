...
exports.getGoogleSignals = getGoogleSignals;
exports.getRedditSignals = getRedditSignals;
exports.getTikTokSignals = getTikTokSignals;
exports.getAliExpressSignals = getAliExpressSignals;
exports.collectAllSignals = collectAllSignals;
/**
...
----------------------------- */
async function getGoogleSignals() {
    const data = [
...
----------------------------- */
async function getTikTokSignals() {
    const data = [
...
----------------------------- */
async function getAliExpressSignals() {
    const data = [
